import sys
sys.path.append("src/")
from alysa.Config import setupcommand, setuplanguages, setupglobal
class Alysa:
	def __init__(self, data = setupcommand.setup(), useless_list = setuplanguages.setup(GLOBAL_LANG)):
		self.data = data
